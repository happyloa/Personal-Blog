...
7. 資料沿著**海底電纜**回到台灣，經過 **ISP**、你家的路由器、**Wi-Fi**，最後到達你的電腦（不過像 YouTube、Google 這類大型服務通常會在各地佈署快取伺服器，熱門影音內容不一定每次都要橫跨海底電纜，可參考〈[CDN 與 Edge Computing](/posts/cdn-edge-computing)〉一文）
